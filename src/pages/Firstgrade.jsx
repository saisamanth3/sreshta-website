      ...
      <div className="content text-center">
        ...
        <nav aria-label="breadcrumb">
          <ol className="breadcrumb">
            <li className="breadcrumb-item active" aria-current="page">First Grade</li>
          </ol>
        </nav>
      </div>
    </div>
        ...
        <div className="col-12">
          <div className="section-title title-inline mb-30" data-aos="fade-up">
            <h2 className="title mb-20">
              ...
              <img className="title-shape lazyload" src="assets/images/placeholder.png" data-src="assets/images/shape/title-shape.png"  />
            </h2>
          </div>
        </div>
        <div className="col-12">
            ...
            <div className="tab-pane slide show active" id="tab1">
              <div className="row">
                <div className="col-xl-3 col-lg-4 col-sm-6">
                  <div className="course-default border radius-md mb-30">
                    <figure className="course-img">
                      <a href="firstgrade-videos.html" title="Image" target="_self" className="lazy-container ratio ratio-2-3">
                    ...
                    <div className="course-details">
                      <div className="p-3">
                        <h6 className="course-title lc-2 mb-0">
                          <a href="firstgrade-videos.html" target="_self" title="Link">
                            Videos
                          </a>
                        </h6>
                      </div>
                      <div className="course-bottom-info px-3 py-2">
                        <span className="font-sm"><a href="firstgrade-videos.html"> View </a><i className="fas fa-long-arrow-right" /></span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-xl-3 col-lg-4 col-sm-6">
                  <div className="course-default border radius-md mb-30">
                    <figure className="course-img">
                      <a href="worksheet-firstgrade.html" title="Image" target="_self" className="lazy-container ratio ratio-2-3">
                    ...
                    <div className="course-details">
                      <div className="p-3">
                        <h6 className="course-title lc-2 mb-0">
                          <a href="worksheet-firstgrade.html" target="_self" title="Link">
                            Worksheets
                          </a>
                        </h6>
                      </div>
                      <div className="course-bottom-info px-3 py-2">
                        <span className="font-sm"><a href="worksheet-firstgrade.html"> View </a><i className="fas fa-long-arrow-right" /></span>
                      </div>
                    </div>
                  </div>
                </div>
