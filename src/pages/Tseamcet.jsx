        ...
        <div className="col-lg-8">
          <div className="banner-content" data-aos="fade-up">
            ...
            <h3 className="title mb-15 mt-10">
              TS - EAMCET is a state level exam for Telangana to get admission into all state level engineering and agriculture courses.                            
            </h3></div>
        </div>
      </div>
    </div>
      ...
      <div className="col-lg-4" data-aos="fade-up">
        <aside className="widget-area bg-white shadow-md radius-md">
          <div className="widget widget-enroll p-25">
            <img className="lazyload" src="assets/images/placeholder.png" data-src="assets/images/exams/tseamcet.jpg" alt="course" />
            <div className="icon-start text-center mt-10 font-sm">
              <span> <h4> TS EAMCET</h4></span>
            </div>
            <ul className="toggle-list list-unstyled mt-20" id="toggleList" data-toggle-show={5}>
              ...
              <li className="icon-start">
                ...
                <span>12th Standard Science Students from Telangana</span>
              </li>
              <li className="icon-start">
                <span>
        ...
        <div className="row justify-content-center">
          <div className="col-lg-12 col-md-12">
            <div data-aos="fade-up">
              <h4 />
              <h2 className="title mb-20">
                All you need to know about TS - EAMCET
                <img className="title-shape lazyload" src="assets/images/placeholder.png" data-src="assets/images/shape/title-shape.png" alt="Shape" />
              </h2>
              <div _ngcontent-c9 className="col-sm-9  pl-4 ">{/*bindings={
                  "ng-reflect-ng-for-of": "[object Object],[object Object"
                }*/}<div _ngcontent-c9><div _ngcontent-c9 className="pt-4" id="ref49"><h3 _ngcontent-c9 className="info headding3">What is TS EAMCET?</h3><div _ngcontent-c9 className="blog-post "><p>Telangana State Engineering, Agriculture &amp; Medical Entrance Test (TS - EAMCET) is a state-level entrance exam, organised by Jawaharlal Nehru Technological University, Hyderabad on behalf of the Council of Higher Education (TSCHE).</p>
                    </div></div></div><div _ngcontent-c9><div _ngcontent-c9 className="pt-4" id="ref50"><h3 _ngcontent-c9 className="info headding3">Syllabus for TS - EAMCET</h3><div _ngcontent-c9 className="blog-post "><p><img alt="" height="50px" src="assets/images/physics.png" width="50px" /> <big><strong>Physics</strong></big></p>
                      <ol>
                        <li>Physical World</li>
                        <li>Units and Dimension</li>
                      ...
                      <ol>
                        ...
                        <li>p-Block Elements - Group 13 (Boron Family)</li>
                        <li>p-Block Elements - Group 14 (Carbon Family)</li>
                      ...
                      <ol>
                        ...
                        <li>Trigonometric Ratios up to Transformations</li>
                        <li>Properties of Triangles</li>
                        <li>Vectors</li>
                        <li>Linear Combination of Vectors</li>
                        <li>Component of a Vector in Three Dimensions</li>
                        <li>Orthogonal Projections</li>
                        <li>Geometrical Vector Methods</li>
                        <li>Vector Equations of a Plane in Different Forms</li>
                        ...
                        <li>A Pair of Straight Lines</li>
                    ...
                    </div></div></div><div _ngcontent-c9><div _ngcontent-c9 className="pt-4" id="ref51"><h3 _ngcontent-c9 className="info headding3">Exam Pattern for TS - EAMCET</h3><div _ngcontent-c9 className="blog-post "><h5><strong>Paper Pattern :</strong></h5>
                      <table border={1}>
                        <thead>
                          <tr>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>Offline mode (pen and paper)</td>
                          </tr>
                          <tr>
                            <td>Exam duration</td>
                            <td>3 hours</td>
                          ...
                          <tr>
                            ...
                            <td>1 mark awarded for each correct answer</td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td>Languages</td>
                            <td>English &amp; Telugu (only in Hyderabad)</td>
                          </tr>
                        </tbody>
                      </table>
                      <p>&nbsp;</p>
