        ...
        <div className="col-lg-8">
          <div className="banner-content" data-aos="fade-up">
            ...
            <h3 className="title mb-15 mt-10">
              One of India’s most prestigious medical institutes, AIIMS offers students admission to its MBBS programmes based on this exam.                            
            </h3></div>
        </div>
      </div>
    </div>
      ...
      <div className="col-lg-4" data-aos="fade-up">
        <aside className="widget-area bg-white shadow-md radius-md">
          <div className="widget widget-enroll p-25">
            <img className="lazyload" src="assets/images/placeholder.png" data-src="assets/images/exams/aiims.PNG" alt="course" />
            <div className="icon-start text-center mt-10 font-sm">
              <span> <h4>AIIMS</h4></span>
            </div>
            <ul className="toggle-list list-unstyled mt-20" id="toggleList" data-toggle-show={5}>
              ...
              <li className="icon-start">
                ...
                <span>Physics, Chemistry, Biology, General Knowledge and Logical Thinking</span>
              </li>
              <li className="icon-start">
                <span>
                  <span className="name">QUESTIONS TYPE:</span>
                </span>
                <span>Objective type MCQs</span>
              </li>
            </ul>
          </div>
        </aside>
          ...
          <div className="col-lg-12 col-md-12">
            <div data-aos="fade-up">
              ...
              <div _ngcontent-c9 className="col-sm-9  pl-4 ">{/*bindings={
                  "ng-reflect-ng-for-of": "[object Object],[object Object"
                }*/}<div _ngcontent-c9><div _ngcontent-c9 className="pt-4" id="ref43"><h3 _ngcontent-c9 className="info headding3">What is AIIMS?</h3><div _ngcontent-c9 className="blog-post "><ul>
                        <li>The All India Institute of Medical Sciences (AIIMS) are a group of autonomous medical colleges of higher education.</li>
                        <li>Through a national level undergraduate medical entrance exam, they grant admissions to students for MBBS programmes.</li>
                        <li>Every year, over 3 lakh students apply for this exam.</li>
                      </ul>
                    </div></div></div><div _ngcontent-c9><div _ngcontent-c9 className="pt-4" id="ref44"><h3 _ngcontent-c9 className="info headding3">Syllabus for AIIMS</h3><div _ngcontent-c9 className="blog-post "><p><img alt="" height="50px" src="assets/images/physics.png" width="50px" /><big><strong> Physics</strong></big></p>
                      <ol>
                      ...
                      <ol>
                        ...
                        <li>Anatomy and Physiology of Plants</li>
                        <li>Anatomy and Physiology of Animals</li>
                    ...
                    </div></div></div><div _ngcontent-c9><div _ngcontent-c9 className="pt-4" id="ref45"><h3 _ngcontent-c9 className="info headding3">Exam Pattern for AIIMS</h3><div _ngcontent-c9 className="blog-post "><table border={1}>
                        <thead>
                          <tr>
                        ...
                        <tbody>
                          <tr>
                            <td>Subjects</td>
                            <td>Physics, Chemistry and Biology, General Knowledge &amp; Aptitude and Logical Thinking</td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td>1/3 mark deducted for each incorrect answer</td>
                          </tr>
                        </tbody>
                      </table>
                      <p>Here is the subject-wise breakup of questions in the AIIMS exam:</p>
                      <table border={1}>
                        <thead>
                          <tr>
