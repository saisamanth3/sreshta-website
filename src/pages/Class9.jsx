              ...
              <div className="row">
                <div className="col-xl-3 col-lg-4 col-sm-6">
                  <div className="course-default border radius-md mb-30">
                    <figure className="course-img">
                      <a href="class9-syllabus.html" title="Image" target="_self" className="lazy-container ratio ratio-2-3">
                    ...
                    <div className="course-details">
                      <div className="p-3">
                        <h6 className="course-title lc-2 mb-0">
                          <a href="class9-syllabus.html" target="_self" title="Link">
                            Maths
                          </a>
                        </h6>
                      </div>
                      <div className="course-bottom-info px-3 py-2">
                        <span className="font-sm"><a href="class9-syllabus.html"> Syllabus </a><i className="fas fa-long-arrow-right" /></span>
                      </div>
                    </div>
                  </div>
                </div>
